...
const Content = (props: { store: ContextMenuCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;
  return (
    <Menu.Content class={props.class} classList={props.classList} store={store.menu}>
      {props.children}
    </Menu.Content>
  );
};
...
const Item = (props: { store: MenuItemCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;
  return (
    <Menu.Item class={props.class} classList={props.classList} store={store}>
      {props.children}
    </Menu.Item>
  );
};
