 ...
 * PopoverContent
 * -----------------------------------------------------------------------------------------------*/
const Content = (props: { store: PopoverCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;
  // const store = useContext(PopoverContext);

  return (
    <PopoverContentNonModal store={store} class={props.class} classList={props.classList}>
      {props.children}
...
/* -----------------------------------------------------------------------------------------------*/
const PopoverContentNonModal = (props: { store: PopoverCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;
  return (
    <PopoverContentImpl store={store} class={props.class} classList={props.classList}>
      {props.children}
    </PopoverContentImpl>
  );
};
...
const PopoverContentImpl = (props: { store: PopoverCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;
