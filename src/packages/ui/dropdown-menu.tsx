...
const SubTrigger = (props: { store: MenuItemCore } & JSX.HTMLAttributes<HTMLElement>) => {
  const { store } = props;

  return (
    <MenuPrimitive.SubTrigger class={props.class} classList={props.classList} store={store}>
      {props.children}
